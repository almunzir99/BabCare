...
namespace apiplate.Migrations
{
    ...
    [Migration("20220321080150_addMeterPriceToBranch")]
    partial class addMeterPriceToBranch
    {
            ...
            modelBuilder.Entity("apiplate.Domain.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 3, 21, 10, 1, 49, 16, DateTimeKind.Local).AddTicks(8573),
                            Email = "almunzir99@gmail.com",
                            IsManager = true,
                            LastUpdate = new DateTime(2022, 3, 21, 10, 1, 49, 26, DateTimeKind.Local).AddTicks(8061),
                            PasswordHash = new byte[] { 191, 49, 1, 75, 24, 86, 191, 244, 255, 47, 157, 164, 133, 100, 75, 145, 182, 94, 25, 135, 16, 155, 53, 156, 194, 105, 239, 252, 24, 168, 10, 222, 86, 155, 4, 182, 233, 252, 108, 194, 9, 181, 70, 171, 8, 127, 154, 109, 234, 187, 187, 197, 122, 62, 211, 237, 91, 135, 212, 243, 24, 80, 3, 137 },
                            PasswordSalt = new byte[] { 214, 0, 168, 244, 63, 125, 131, 27, 174, 193, 103, 153, 239, 190, 236, 35, 42, 21, 202, 248, 87, 183, 79, 49, 86, 73, 223, 36, 163, 193, 242, 158, 95, 82, 254, 90, 108, 36, 95, 199, 142, 154, 162, 108, 244, 219, 237, 157, 57, 69, 158, 92, 181, 217, 122, 92, 169, 132, 7, 130, 185, 11, 146, 132, 85, 96, 211, 88, 121, 68, 152, 77, 181, 7, 81, 146, 35, 178, 193, 1, 24, 146, 186, 140, 250, 168, 103, 118, 153, 73, 163, 147, 24, 218, 40, 66, 58, 207, 90, 236, 192, 92, 21, 250, 15, 123, 92, 28, 128, 236, 6, 7, 164, 99, 250, 186, 195, 246, 154, 46, 72, 201, 244, 234, 238, 34, 229, 18 },
                            Phone = "249128647019",
                            Username = "almunzir99"
                        });
                });
