...
namespace apiplate.Migrations
{
    ...
    [Migration("20220328125016_addFavoriteToCustomer")]
    partial class addFavoriteToCustomer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("apiplate.Domain.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 3, 28, 14, 50, 15, 489, DateTimeKind.Local).AddTicks(1107),
                            Email = "almunzir99@gmail.com",
                            IsManager = true,
                            LastUpdate = new DateTime(2022, 3, 28, 14, 50, 15, 495, DateTimeKind.Local).AddTicks(3145),
                            PasswordHash = new byte[] { 246, 57, 186, 57, 238, 145, 192, 39, 17, 162, 110, 11, 204, 208, 90, 235, 55, 153, 155, 122, 170, 164, 10, 116, 145, 240, 152, 169, 172, 28, 162, 222, 198, 80, 163, 13, 31, 237, 90, 245, 129, 170, 106, 36, 125, 140, 211, 206, 106, 61, 75, 14, 149, 40, 248, 79, 48, 29, 139, 140, 3, 129, 252, 11 },
                            PasswordSalt = new byte[] { 134, 126, 65, 243, 69, 205, 33, 108, 35, 121, 99, 191, 163, 215, 207, 179, 93, 174, 245, 121, 71, 188, 147, 157, 13, 48, 161, 2, 115, 64, 114, 2, 240, 102, 254, 139, 196, 43, 124, 124, 211, 10, 63, 36, 151, 221, 141, 23, 193, 67, 139, 29, 79, 129, 95, 79, 66, 166, 82, 22, 148, 93, 123, 187, 182, 3, 70, 89, 146, 97, 251, 229, 242, 64, 169, 202, 168, 163, 71, 8, 1, 31, 233, 86, 29, 66, 2, 150, 58, 45, 136, 251, 192, 19, 100, 92, 234, 240, 154, 202, 29, 102, 193, 52, 28, 46, 159, 232, 68, 86, 145, 186, 249, 141, 113, 150, 138, 154, 198, 22, 63, 17, 247, 176, 172, 205, 217, 205 },
                            Phone = "249128647019",
                            Username = "almunzir99"
                        });
                });
            ...
            modelBuilder.Entity("apiplate.Domain.Models.Favorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
