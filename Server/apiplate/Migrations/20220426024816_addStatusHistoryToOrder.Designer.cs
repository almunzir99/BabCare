...
namespace apiplate.Migrations
{
    ...
    [Migration("20220426024816_addStatusHistoryToOrder")]
    partial class addStatusHistoryToOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("apiplate.Domain.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 4, 26, 4, 48, 15, 173, DateTimeKind.Local).AddTicks(6132),
                            Email = "almunzir99@gmail.com",
                            IsManager = true,
                            LastUpdate = new DateTime(2022, 4, 26, 4, 48, 15, 174, DateTimeKind.Local).AddTicks(6445),
                            PasswordHash = new byte[] { 82, 8, 134, 136, 253, 146, 203, 0, 248, 65, 252, 215, 204, 65, 28, 24, 231, 48, 33, 44, 101, 187, 112, 135, 20, 135, 3, 207, 26, 142, 44, 47, 26, 223, 163, 200, 4, 5, 216, 234, 250, 1, 145, 65, 70, 122, 165, 222, 93, 121, 13, 185, 232, 21, 210, 101, 89, 65, 46, 228, 110, 102, 173, 117 },
                            PasswordSalt = new byte[] { 36, 121, 147, 33, 35, 78, 192, 201, 54, 227, 82, 153, 41, 39, 197, 41, 189, 185, 193, 143, 77, 255, 123, 159, 209, 190, 113, 44, 31, 195, 7, 208, 239, 103, 217, 59, 207, 203, 13, 27, 211, 146, 104, 95, 164, 189, 129, 241, 227, 0, 42, 240, 2, 11, 63, 119, 14, 221, 195, 79, 94, 254, 64, 140, 123, 196, 91, 29, 94, 14, 28, 30, 218, 205, 63, 110, 221, 73, 102, 218, 193, 19, 210, 29, 223, 2, 27, 104, 125, 56, 153, 92, 49, 191, 111, 43, 60, 185, 35, 134, 149, 75, 39, 239, 21, 133, 233, 40, 146, 6, 222, 37, 148, 185, 228, 239, 152, 104, 201, 54, 219, 198, 140, 8, 230, 213, 210, 40 },
                            Phone = "249128647019",
                            Username = "almunzir99"
                        });
                });
            ...
            modelBuilder.Entity("apiplate.Domain.Models.StatusHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
